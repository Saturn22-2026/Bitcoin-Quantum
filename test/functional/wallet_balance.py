...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Prep for fork
        fork_blocks0 = create_empty_fork(self.nodes[0])
        fork_blocks1 = create_empty_fork(self.nodes[1])
        ...
        trigger_reorg(self.nodes[0], fork_blocks0)
        trigger_reorg(self.nodes[1], fork_blocks1)
